<template>
  <div class="new-songs">
    <div class="new-songs-top">
      ...
      <router-link tab="div" class="new-songs-right" to="/songandalbum" v-if="isShow">更多新碟</router-link>
      <router-link tab="div" class="new-songs-right" to="/songandalbum" v-if="show">新歌推荐</router-link>
    </div>
