      ...
      <cube-sticky :pos="scrollY">
        ...
        >
          ...
          <ul class="comment-message">
            <li>
              <song-list-comment :album="album"></song-list-comment>
            </li>
          </ul>
...
<script>
    ...
    import songListComment from '../../../base/swiper/albumcommenttop'
    ...
    export default {
      ...
      methods: {
        getComment (id, offset, limit) {
          this.$api.albums.albumcomment(id, offset, limit).then(res => {
